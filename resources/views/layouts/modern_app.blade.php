...
<head>
  ...
  <title>Klinik cinta sehat</title>
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="has-arrow sidebar-link d-flex justify-content-between align-items-center" href="javascript:void(0)" aria-expanded="false">
                <div>
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="{{ route('poli.index') }}" class="sidebar-link">
                    <i class="ti ti-eye"></i>
                    <span class="hide-menu">Tampilan Data Poli</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="{{ route('poli.create') }}" class="sidebar-link">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="{{ route('pasien.index') }}" class="sidebar-link">
                    <i class="ti ti-eye"></i>
                    <span class="hide-menu">Lihat Data Pasien</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="{{ route('pasien.create') }}" class="sidebar-link">
                    <i class="ti ti-plus"></i>
            ...
            <li class="sidebar-item">
              <a class="has-arrow sidebar-link d-flex justify-content-between align-items-center" href="javascript:void(0)" aria-expanded="false">
                <div>
                  <i class="ti ti-user"></i>
                  <span class="hide-menu">Daftar Pasien</span>
                </div>
                <i class="ti ti-chevron-down"></i>
              </a>
              <ul aria-expanded="false" class="collapse first-level">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link" href="{{ route('daftar.create') }}" aria-expanded="false">
                    <i class="ti ti-layout-dashboard"></i>
                    <span class="hide-menu">Tambah Daftar Pasien</span>
                  </a>
                </li>
              </ul>
            </li>
